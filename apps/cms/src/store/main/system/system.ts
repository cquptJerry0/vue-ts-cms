  ...
  actions: {
    async postUsersListAction(queryInfo: any) {
      const usersListResult =
        await postUsersListData(queryInfo)
    ...
    async deletePageByIdAction(
      pageName: string,
      id: number,
    ) {
      const deleteResult = await deletePageById(
        pageName,
        id,
      )
      console.log(deleteResult)
    ...
    async newPageDataAction(
      pageName: string,
      pageInfo: any,
    ) {
      const newResult = await newPageData(
        pageName,
        pageInfo,
      )
      console.log(newResult)
